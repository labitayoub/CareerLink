        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="./auth/registre.php" onclick="showSignup()">Inscription</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div id="mainContent">
        ...
        <div class="container my-5" id="jobs">
            ...
            <div class="job-card">
                ...
                <p class="text-muted">LabitA - Yousoufia</p>
                <div>CDI - 10-15K DH</div>
            </div>
            <div class="job-card">
                <h3>Support IT</h3>
